        ...
        <div class="card-body search-group">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                         ...
                         <div class="col-sm-12">
                            <label class="col-sm-12 col-form-label">@lang('admin.creation_date_to')</label>
                            <input type="date" wire:model="search_creation_at" placeholder="{{ trans('admin.creation_date_to') }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select class=" form-select form-select-sm" wire:model="category_search" aria-label=".form-select-sm example">
                        ...
                        <div class="col-sm-12">
                            <label class="col-sm-12 mt-2 col-form-label">@lang('charityProject.type')</label>
                ...
                <div class="col-md-3">
                    <div class="row">
                        {{-- <div class="col-sm-12">
                            <label class="col-sm-12 col-form-label">@lang('admin.hidden')</label>
                ...
                <table id="main-datatable" class="table table-striped table-bordered ">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>{{ trans('charityProject.target_price') }}</th>
                    ...
                    <tbody>
                        ...
                        @livewire('admin.charity.projects.table', [
                        'item' => $item,
                        ...
                        @endforelse
                          {{-- <tr style="background-color: lightblue; font-weight: bold;">
                            ...
                            <td></td>
                            <td></td>
                            <td>الإجمالي : {{ number_format($totalTargetAmount ?? 0, 2) }}</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
